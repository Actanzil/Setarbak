<?php
    if (isset($_SESSION['id_user'])) {
        ...
        if (empty($nama)) {
            header("Location:edit-user-data-".$id_user."_notif-editkosong-jenis-Nama");
        }elseif (empty($email)) {
            header("Location:edit-user-data-".$id_user."_notif-editkosong-jenis-Email");
        }elseif (empty($username)) {
            header("Location:edit-user-data-".$id_user."_notif-editkosong-jenis-Username");
        }else {
